      ...
      <div className="max-w-4xl w-full bg-white p-8 rounded-lg shadow-md">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed mt-2">
            By accessing this website/app, we assume you accept these terms and conditions. Do not continue to use Krishi Sahayak if you do not agree to take all of the terms and conditions stated on this page.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc list-inside text-gray-700 ml-4">
            <li>Republish material from Krishi Sahayak</li>
            <li>Sell, rent or sub-license material from Krishi Sahayak</li>
            <li>Reproduce, duplicate or copy material from Krishi Sahayak</li>
            <li>Redistribute content from Krishi Sahayak</li>
          </ul>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed mt-2">
            Krishi Sahayak reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive or causes breach of these Terms and Conditions.
          </p>
          <p className="text-gray-700 leading-relaxed mt-2">
            You warrant and represent that:
          </p>
          <ul className="list-disc list-inside text-gray-700 ml-4">
            <li>You are entitled to post the Comments on our website/app and have all necessary licenses and consents to do so;</li>
            <li>The Comments do not invade any intellectual property right, including without limitation copyright, patent or trademark of any third party;</li>
            <li>The Comments do not contain any defamatory, libelous, offensive, indecent or otherwise unlawful material which is an invasion of privacy</li>
            <li>The Comments will not be used to solicit or promote business or custom or present commercial activities or unlawful activity.</li>
          </ul>
          <p className="text-gray-700 leading-relaxed mt-2">
            You hereby grant Krishi Sahayak a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc list-inside text-gray-700 ml-4">
            ...
            <li>Online directory distributors may link to our Website/App in the same manner as they hyperlink to the Websites/Apps of other listed businesses; and</li>
            <li>System wide Accredited Businesses except soliciting non-profit organizations, charity shopping malls, and charity fundraising groups which may not hyperlink to our Web site/App.</li>
          </ul>
          <p className="text-gray-700 leading-relaxed mt-2">
            These organizations may link to our home page, to publications or to other Website/App information so long as the link: (a) is not in any way deceptive; (b) does not falsely imply sponsorship, endorsement or approval of the linking party and its products and/or services; and (c) fits within the context of the linking party’s site.
          </p>
          <p className="text-gray-700 leading-relaxed mt-2">
          ...
          <p className="text-gray-700 leading-relaxed mt-2">
            We will approve link requests from these organizations if we decide that: (a) the link would not make us look unfavorably to ourselves or to our accredited businesses; (b) the organization does not have any negative records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of Krishi Sahayak; and (d) the link is in the context of general resource information.
          </p>
          <p className="text-gray-700 leading-relaxed mt-2">
            These organizations may link to our home page so long as the link: (a) is not in any way deceptive; (b) does not falsely imply sponsorship, endorsement or approval of the linking party and its products or services; and (c) fits within the context of the linking party’s site.
          </p>
          <p className="text-gray-700 leading-relaxed mt-2">
            If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website/app, you must inform us by sending an e-mail to Krishi Sahayak. Please include your name, your organization name, contact information as well as the URL of your site, a list of any URLs from which you intend to link to our Website/App, and a list of the URLs on our site to which you would like to link. Wait 2-3 weeks for a response.
          </p>
        </section>
