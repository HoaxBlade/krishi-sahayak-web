...
# Multi-Model Krishi Sahayak Deployment Script using Cloud Build
# This script deploys the enhanced multi-model system to Google Cloud

set -e

echo "🚀 Starting Multi-Model Krishi Sahayak Deployment with Cloud Build..."
echo "=================================================================="

# Configuration
PROJECT_ID="composed-slice-410214"
REGION="us-central1"
CLUSTER_NAME="krishi-sahayak-cluster"
...
# Step 1: Build and push Docker image using Cloud Build
